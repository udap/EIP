...
public class MyAddress1 implements Type<String> {

    public static final String TYPE_NAME = "address";
    public static final int LENGTH = 160; // bits
    public static final int LENGTH_IN_HEX = LENGTH >> 2;
    public static final MyAddress1 DEFAULT = new MyAddress1(BigInteger.ZERO);

    private final Uint160 value;

    public MyAddress1(Uint160 value) {
        this.value = value;
    }

    public MyAddress1(BigInteger value) {
        this(new Uint160(value));
    }

    public MyAddress1(Object o) {
    ...
    public MyAddress1(String hexValue) {
    ...
    public boolean equals(Object o) {
        ...
        MyAddress1 address = (MyAddress1) o;
